...
public final class SodiumReliefRuntime {
    ...
    public void initialize() {
        ...
        ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES).registerReloadListener(new CacheResetReloader());
    }
    ...
    private final class CacheResetReloader implements SimpleSynchronousResourceReloadListener {
        ...
        public Identifier getFabricId() {
            return Identifier.of(SodiumReliefClient.MOD_ID, "cache_reset");
        }
