...
public final class ReliefDebugOverlay {
    ...
    public void initialize() {
        // The HUD-element registry (rendering.v1.hud) only exists in the 1.21.6+ Fabric API;
        // this range uses the older HudRenderCallback, which is present across all of 1.21.x.
